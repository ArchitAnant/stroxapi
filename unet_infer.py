...
def main():
	...
	unet.load_state_dict(torch.load(args.unet_ckpt, weights_only=True))  # verify file exists
	...
	style_encoder.load_state_dict(torch.load(args.style_encoder_ckpt, weights_only=True))  # verify file exists
